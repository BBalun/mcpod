...
export async function fetchExternalPhotometryData(hip: string | null, tyc: string | null) {
  ...
  return {
    Hp: res.Hp,
    Bt: filterOutliers(res.Bt, hipparcosMeanMagnitude - 0.5, hipparcosMeanMagnitude + 0.5),
    Vt: filterOutliers(res.Vt, hipparcosMeanMagnitude - 0.5, hipparcosMeanMagnitude + 0.5),
  };
}
